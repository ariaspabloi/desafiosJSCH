...
let climas = {
    ...
    "Sleet": "Cellisca",
    "Hail": "Granizo",
    "ThunderStrom": "Tormenta electrica",
    "Heavy Rain": "Lluvia torrencial",
    "Light Rain": "LLuvia",
    "Showers": "Chubascos",
    "Heavy Cloud": "Nublado",
    "Light Cloud": "Levemente nublado",
    "Clear": "Despejado"
};
...
async function searchCity() {
    let searchAlert = searchingAlert();
    //Search the city
    await fetchLocation();
    searchAlert.hideToast();
    //City found?
...
function setWeather(day) {
    ...
    dateFormatted = dateFormatted.at(0).toUpperCase() + dateFormatted.slice(1); //Make uppercase the first letter of the day.
    ...
    weatherStateElement.innerText = climas[state];
